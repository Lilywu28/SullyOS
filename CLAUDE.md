...
| **跑团 · 五档检定/逐人状态/死亡/皮下吐槽** | [`docs/trpg-check-mechanics.md`](./docs/trpg-check-mechanics.md) | 改跑团(GameApp)的判定/骰点逻辑（全员先骰、`checks[]`、AI自算成败+代码机械复核）、逐人 HP/SAN 面板、死亡/昏迷/疯狂机制（`statusChanges[]`）、可选皮下吐槽 OOC 频道（独立LLM调用、不污染主线）前必读 |
